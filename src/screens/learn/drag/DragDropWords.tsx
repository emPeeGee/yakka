...
import type { DragDropWordsAnimatedStyleWorklet, OnDropFunction } from './types';
import { Word } from './Word';
import { WordContext } from './WordContext';

export interface DragDropWordsProps {
  /** List of words */
  words: string[];
  ...
  animatedStyleWorklet?: DragDropWordsAnimatedStyleWorklet;
...
const DragDropWordsComp = forwardRef<DragDropWordsRef, DragDropWordsProps>((props, ref) => {
  const {
    words,
    extraData,
    renderWord,
...
const DragDropWordsInstance = forwardRef<DragDropWordsRef, DragDropWordsProps>((props, ref) => {
  ...
  return <DragDropWordsComp ref={ref} {...props} key={wordsKey} />;
});

export const DragDropWords = memo(DragDropWordsInstance);
